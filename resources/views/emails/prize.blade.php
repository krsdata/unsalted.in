                        ...
                        <table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer">
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 20px 10px 8px 10px;"><!-- CONTENT TABLE // -->
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style="text-align:justify;font-family:calibri, Lucida Grande;font-size: 16px;margin-bottom:0;color:#333;line-height: 22px;"><strong>Hi {!!$content['first_name']??''!!},</strong></div></td>
                                </tr>
                              </table>
                          ...
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 10px 10px 10px 10px;"><!-- CONTENT TABLE // -->
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="20%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style=" text-align:center;font-family:calibri, Lucida Grande;font-size: 17px;margin-bottom:0;color:#fff;line-height: 22px; background:#c61d22; padding:10px;">Your Rank : {!!$content['rank']??''!!}</div></td>
                                </tr>
                              </table>
                        ...
                        <table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer">
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 0px 10px 10px 10px;"><!-- CONTENT TABLE // -->
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style="text-align:justify;font-family:calibri, Lucida Grande;font-size: 16px;margin-bottom:0;color:#333;line-height: 22px;">Congratulation !</div></td>
                                </tr>
                              </table>
                        ...
                        <table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer">
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 20px 10px 20px 10px;"><!-- CONTENT TABLE // -->
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style="text-align:center;font-family:calibri, Lucida Grande;font-size: 16px;margin-bottom:0;color:#333;line-height: 22px;"><img src="{{url('assets/mail_icons/rupees.png')}}"  style="max-width:100%; margin:auto;"></div></td>
                                </tr>
                              </table>
