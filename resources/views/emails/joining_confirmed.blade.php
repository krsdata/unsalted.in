...
<meta property="og:title" content="JITO USA" />
...
@import url('https://fonts.googleapis.com/css?family=Abril+Fatface|Alex+Brush|Roboto+Slab|Source+Serif+Pro|Work+Sans');
@import url('https://fonts.googleapis.com/css?family=Abril+Fatface|Alex+Brush|Roboto+Slab|Source+Serif+Pro|Work+Sans');
...
.mobile-width img{ margin-top:5px;}
...
.maintable{ width:inherit !important}
/* TAB STYLES */
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td align="center" valign="top"><!-- FLEXIBLE CONTAINER // -->
                        ...
                        <table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer">
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 20px 10px 8px 10px;"><!-- CONTENT TABLE // -->
                              
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style="text-align:justify;font-family:calibri, Lucida Grande;font-size: 16px;margin-bottom:0;color:#333;line-height: 22px;"><strong>Hi ,</strong></div></td>
                                </tr>
                              </table>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style="text-align:justify;font-family:calibri, Lucida Grande;font-size: 16px;margin-bottom:0;color:#333;line-height: 22px;">
                                  	...
                                  	You've successfully joined the contest with an entry fee of Rs.15 for the 28 Feb 20 

                                  	<strong>NZ vs IND</strong> match.</div>
...
<tr mc:hideable="mc:hideable">
                          ...
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 10px 10px 10px 10px;"><!-- CONTENT TABLE // -->
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="20%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style=" text-align:center;font-family:calibri, Lucida Grande;font-size: 17px;margin-bottom:0;color:#fff;line-height: 22px; background:#c61d22; padding:10px;">Check My Rank </div></td>
                                </tr>
                              </table>
                        ...
                        <table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer">
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 0px 10px 10px 10px;"><!-- CONTENT TABLE // -->
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style="text-align:justify;font-family:calibri, Lucida Grande;font-size: 16px;margin-bottom:0;color:#333;line-height: 22px;">Sit back, relax & watch your favourite players in action!</div></td>
                                </tr>
                              </table>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td align="center" valign="top"><!-- FLEXIBLE CONTAINER // -->
                        ...
                        <table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer">
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 20px 10px 20px 10px;"><!-- CONTENT TABLE // -->
                              
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style="text-align:center;font-family:calibri, Lucida Grande;font-size: 16px;margin-bottom:0;color:#333;line-height: 22px;"><img src="rupees.png"  style="max-width:100%; margin:auto;"></div></td>
                                </tr>
                              </table>
                        ...
                        <table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer">
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 0px 10px 10px 10px;"><!-- CONTENT TABLE // -->
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" align="center" class="textContent"><div style="text-align:center;font-family:calibri, Lucida Grande;font-size: 16px;margin-bottom:0;color:#333;line-height: 22px;"> Invite your friends & earn as they play!</div></td>
                                </tr>
                              </table>
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr> <td class="mobile-width" style="width: 50%;">
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tbody>
                                                <tr>
                                                  <td style="text-align:center;font-family:calibri, Lucida Grande;font-size: 15px;margin-bottom:0;color:#333;line-height: 22px; color: #333;" ><a href="" target="_blank"><img src="appstore.png"  style="max-width:100%; margin:auto;"></a></td>
                                                </tr>
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tbody>
                                                <tr>
                                                  <td style="text-align:center;font-family:calibri, Lucida Grande;font-size: 15px;margin-bottom:0;color:#333;line-height: 22px; color: #333;" ><a download href="" target="_blank"><img src="android.png"  style="max-width:100%; margin:auto;"></a></td>
                                                </tr>
  ...
  <tbody>
    <tr>
      <td><a href="" target="_blank" style="padding-right: 8px;"><strong>Contact Us</strong> |</a><a href="" target="_blank" style="padding-right: 8px;"><strong>FairPlay</strong> |</a><a href="https://twitter.com/AshiDiamondsLLC" target="_blank" style="padding-right: 8px;"><strong>Email Preferences</strong></a></td>
    </tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td align="center" valign="top"><!-- FLEXIBLE CONTAINER // -->
                        ...
                        <table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer">
                          <tr>
                            <td valign="top" width="700" class="flexibleContainerCell" style="padding: 10px 10px 10px;"><!-- CONTENT TABLE // -->
