                                        ...
                                        <div class=" pull-right">
                                            <div   class="input-group"> 
                                                <a href="{{ route('notification')}}">
                                                    <button  class="btn btn-success"><i class="fa fa-plus-circle"></i> All Notification</button> 
                                                </a> 
                                            </div>
                                        </div>
                                        <div class="col-md-2 pull-right"> 
                                             <div  class="input-group pull-right"> 
                                                 ...
                                                 <a href="{{ route('notification.edit',$result->id)}}">
                                                    <button  class="btn btn-success"><i class="fa fa-plus-circle"></i> Edit notification</button> 
                                                </a>
                                            </div>
                                        </div>
                                    </div>
