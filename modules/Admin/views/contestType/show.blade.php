                                        ...
                                        <div class=" pull-right">
                                            <div   class="input-group"> 
                                                <a href="{{ route('contestType')}}">
                                                    <button  class="btn btn-success"><i class="fa fa-plus-circle"></i> All contestType</button> 
                                                </a> 
                                            </div>
                                        </div>
                                        <div class="col-md-2 pull-right"> 
                                             <div  class="input-group pull-right"> 
                                                 ...
                                                 <a href="{{ route('contestType.edit',$result->id)}}">
                                                    <button  class="btn btn-success"><i class="fa fa-plus-circle"></i> Edit contestType</button> 
                                                </a>
                                            </div>
                                        </div>
                                    </div>
